...
export default function SocialMedia() {
  ...
  return (
    <DesignPage
      ...
      title="Sporting Image"
      header_description="Imagens autorais, como flyers esportivos, tabelas e outros materiais relacionados."
      description="Explore meus trabalhos referentes aos flyes esportivos em diversos contextos."
    />
  );
}
