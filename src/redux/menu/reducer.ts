  ...
  buttonsMenu: [
    ...
    },
    {
      ...
      dropdown: [
        {
          name: 'EPoint',
          url: 'https://e-point.vercel.app/',
          imageUrl: 'https://i.postimg.cc/pLQFfjPJ/screencapture-e-point-vercel-app-2024-01-05-13-57-30.png',
          description: 'Plataforma intermediadora de eventos competitivos.',
          date: '01/04/2023',
        },
        {
          name: 'YourQuiz',
        ...
        },
        {
          ...
          description:
            'Projeto ao qual consiste em um botão que consegui deixar o elemento em tela cheia, desenvolvido pelo React.',
          date: '09/09/2022',
        },
        {
          name: 'Cursor Select',
        ...
        },
        {
          ...
          description:
            'Extensão do Chrome ao qual customiza a aba aberta do navegador, como textos, background e imagens.',
          date: '08/08/2022',
        },
        {
          name: 'Pokédex',
